...
async def test_reminder_workflow_integration() -> None:
    ...
    assert "agenda updated successfully" in final_output.lower() or "buffer updated successfully" in final_output.lower() or "added" in final_output.lower() or "agenda" in final_output.lower()
